  ...
  Scenario: Create Order for existing customer
    When client requests POST on http://192.168.99.100:8003/shopping-cart/order-for-existing-customer with json data:
      """
    ...
    When client requests POST on http://192.168.99.100:8003/shopping-cart/order-for-new-customer with json data:
      """
